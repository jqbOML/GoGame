...
class KamienTest {
    ...
    public void czyOddechTest() {
        kamienie[3][2] = new Kamien(1); //brak oddechow dla pojedynczego kamienia
    ...
    void czyUduszoneTest() {
        ...
        kamienie[4][2] = new Kamien(1); //5 bialych kamienii do uduszenia
        ...
        kamienie[2][1] = new Kamien(2); //czarne kamienie otaczające
        kamienie[3][2].czyOddechLancuch(3,2, kamienie); //sprawdz oddechy dla lanucha, do ktorego nalezy kamien [3][2]

        kamienie[5][3] = new Kamien(2);
        kamienie[4][4] = new Kamien(2);
